<template>
    <div class="grid grid-cols-1 gap-8 py-8 px-6 sm:grid-cols-3 justify-items-center" data-aos="zoom-out"
        ...
        <div class="ml-20">
            ...
            <ul class="text-white">
                <li class="mb-4 flex space-x-5 items-center">
                    <div class="">
                        <fa icon="location-dot" class="text-4xl" />

                    </div>
                    <div>
                        <h1 class="text-lg font-extrabold"> Offical Address</h1>
                ...
                <li class="mb-4 flex space-x-5 items-center">
                    <div>
                        <font-awesome-icon icon="fa-light fa-phone" />
                        <fa icon="envelope" class="text-4xl" />
                    </div>
                    <div>
                        <h1 class="text-lg font-extrabold">Email me</h1>
                        <p class="text-sm text-gray-500">
                            solomonadola84@gmail.com</p>
                    </div>

                </li>
                <li class="mb-4 flex space-x-5 items-center">
                    <div>
                        <fa icon="phone" class="text-4xl" />
                    </div>
                    <div>
                        <h1 class="text-lg font-extrabold">Give me a Call</h1>
                        <p class="text-sm text-gray-500">
                            +251984695747
                        </p>
                    </div>
        ...
        <div>
            <h2 class="mb-6 text-lg font-bold text-white uppercase">Services</h2>
            <ul class="text-gray-300">
                ...
                <li class="mb-4 flex space-x-5 items-center">
                    <a href="#" class="hover:underline">Mobile Development </a>
                </li>
            ...
            <ul class="text-gray-300 flex justify-center space-x-2">
                ...
                <li class="mb-4 border-2 border-gray-600 p-2 rounded-full hover:border-white">
                    <a href="#" class="text-gray-400 hover:text-white">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 44 44" aria-hidden="true">
                            <path
